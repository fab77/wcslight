...
/* harmony import */ var _projections_InHiPSProjection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projections/InHiPSProjection */ "./src/projections/InHiPSProjection.js");
...
var WCSLight = /*#__PURE__*/function () {
  ...
  function WCSLight(center, radius, pxsize, outProjectionName, inProjectionName) {
    ...
    try {
      ...
      if (this._inprojection instanceof _projections_InHiPSProjection__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]) {
        this._tilesMap = this._inprojection.generateTilesMap(this._outprojection.getOutputImage()); // the program calling WCSLight must iterate over tilesMap and:
  ...
  _createClass(WCSLight, [{
    key: "fillOutputImage",
    value: function fillOutputImage(inData) {
      var _this = this;

      var tileno = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      ...
      if (this._inprojection instanceof _projections_InHiPSProjection__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]) {
        ...
        var tilesMap = this._inprojection.getTilesMap();

        tilesMap.get(tileno).forEach(function (imgpx) {
          var pxij = _this._inprojection.world2pix(imgpx.ra, imgpx.dec);

          var pxval = _this._inprojection.getValue(pxij.i, pxij.j, inData); // <-- TODO to be implemented!!! Take it from FITSOnTheWeb


          imgpx.value = pxval;

          _this._outprojection.setPxValue(imgpx);
        });
      }
    }
    /**
    ...
    key: "getHiPSTilesMap",
    value: function getHiPSTilesMap() {
      return this._inprojection.getTilesMap(); // if (this._tilesMap === undefined) {
...
var ImagePixel = /*#__PURE__*/function () {
   ...
   */
  function ImagePixel(ra, dec) {
    var i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var j = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var tileno = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    ...
    _defineProperty(this, "_tileno", void 0);
...
var TilesMap = /*#__PURE__*/function () {
  function TilesMap(nside) {
    _classCallCheck(this, TilesMap);

    _defineProperty(this, "_nside", void 0);

    _defineProperty(this, "_norder", void 0);
  ...
  _createClass(TilesMap, [{
    ...
    key: "pushImgPx2Tile",
    value: function pushImgPx2Tile(tileno, imgpx) {
...
/* harmony default export */ __webpack_exports__["a"] = (TilesMap);

/***/ }),

/***/ "./src/projections/AbstractInProjection.js":
/*!*************************************************!*\
  !*** ./src/projections/AbstractInProjection.js ***!
  \*************************************************/
/*! exports provided: default */
...
var AbstractInProjection = function AbstractInProjection() {
  _classCallCheck(this, AbstractInProjection);

  if ((this instanceof AbstractInProjection ? this.constructor : void 0) === AbstractInProjection) {
...
/* harmony default export */ __webpack_exports__["a"] = (AbstractInProjection);
...
var HEALPixProjection = /*#__PURE__*/function (_AbstractProjection) {
  ...
  function HEALPixProjection(center, radius, pxsize) {
    ...
    _this._hp = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(nside);
  ...
  _createClass(HEALPixProjection, [{
    ...
    key: "computeBbox",
    value: function computeBbox(phiTheta_rad, r) {
      var bbox = [];
    ...
    value: function init(nside, pixno, naxis1, naxis2) {
      ...
      var healpix = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(nside);
    ...
    */
    ...
    value: function getFacetProjectedCoordinates(nside) {
      ...
      var pix = this.pixno;
      var healpix = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(this._nside);
...
/***/ "./src/projections/HiPSProjection.js":
/*!*******************************************!*\
  !*** ./src/projections/HiPSProjection.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _AbstractProjection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AbstractProjection */ "./src/projections/AbstractProjection.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _model_TilesMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/TilesMap */ "./src/model/TilesMap.js");
...
var HiPSProjection = /*#__PURE__*/function (_AbstractProjection) {
  _inherits(HiPSProjection, _AbstractProjection);

  var _super = _createSuper(HiPSProjection);
  ...
  // _pxsize;
  // _radius;
  // used when this projection is used as input projection
   ...
   * @param {*} pxsize decimal degrees
   */
  function HiPSProjection(center, radius, pxsize) {
    var _this;

    _classCallCheck(this, HiPSProjection);
    ...
    _defineProperty(_assertThisInitialized(_this), "_tilesMap", void 0);
    ...
    _this.THETAX = !(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).asin((K - 1) / K);
    _this._nside = _this.computeNside(pxsize);
    _this._hp = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(_this._nside);
  ...
  _createClass(HiPSProjection, [{
    ...
    key: "generateTilesMap",
    value: function generateTilesMap(raDecMap) {
      this._tilesMap = new _model_TilesMap__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"](this._nside); // rows

      for (var i = 0; i < raDecMap.length; i++) {
        // cols
        for (var j = 0; j < raDecMap[i].length; j++) {
          var imgpx = raDecMap[i][j];
          var phiTheta_rad = astroDegToSphericalRad(imgpx.getRA(), imgpx.getDec());
          var ptg = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null, false, phiTheta_rad.theta_rad, phiTheta_rad.phiRad);

          var tileno = this._hp.ang2pix(ptg);
  ...
  return HiPSProjection;
}(_AbstractProjection__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]);

/* harmony default export */ __webpack_exports__["a"] = (HiPSProjection);

/***/ }),

/***/ "./src/projections/InHiPSProjection.js":
/*!*********************************************!*\
  !*** ./src/projections/InHiPSProjection.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
/* harmony import */ var _AbstractInProjection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AbstractInProjection */ "./src/projections/AbstractInProjection.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'healpixjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _model_TilesMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/TilesMap */ "./src/model/TilesMap.js");
...
var InHiPSProjection = /*#__PURE__*/function (_AbstractInProjection) {
  _inherits(InHiPSProjection, _AbstractInProjection);

  var _super = _createSuper(InHiPSProjection);
   ...
   * @param {*} pxsize decimal degrees
   */
  function InHiPSProjection(center, radius, pxsize) {
    var _this;

    _classCallCheck(this, InHiPSProjection);
  ...
  _createClass(InHiPSProjection, [{
    ...
    value: function init(pixno) {
      ...
      var cornersVec3 = this._hp.getBoundariesWithStep(pixno, 1);
  ...
  return InHiPSProjection;
}(_AbstractInProjection__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]);

/* harmony default export */ __webpack_exports__["a"] = (InHiPSProjection);
...
var MercatorProjection = /*#__PURE__*/function (_AbstractProjection) {
  ...
  function MercatorProjection(center, radius, pxsize) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_pxmatrix", void 0);

    _defineProperty(_assertThisInitialized(_this), "_fitsheader", void 0);

    _this.computeSquaredNaxes(2 * radius, pxsize);
  ...
  _createClass(MercatorProjection, [{
    ...
    key: "computeSquaredNaxes",
    value: function computeSquaredNaxes(d, ps) {
    ...
    value: function generatePxMatrix() {
      ...
      for (var j = 0; j < this._naxis2; j++) {
        // rows
        var row = new Array(this._naxis1);
    ...
    key: "setPxValue",
    value: function setPxValue(imgpx) {
      this._pxmatrix[imgpx.i][imgpx.j] = imgpx;
    }
  }, {
    key: "getOutputImage",
    value: function getOutputImage() {
...
/* harmony import */ var _HiPSProjection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./HiPSProjection */ "./src/projections/HiPSProjection.js");
/* harmony import */ var _MercatorProjection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MercatorProjection */ "./src/projections/MercatorProjection.js");
/* harmony import */ var _exceptions_ProjectionNotFound__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../exceptions/ProjectionNotFound */ "./src/exceptions/ProjectionNotFound.js");
  ...
  _createClass(ProjFactory, null, [{
    ...
    value: function getProjection(center, radius, pxsize, projectionName) {
      if (projectionName === "Mercator") {
        return new _MercatorProjection__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"](center, radius, pxsize);
      } else if (projectionName === "HiPS") {
        return new _HiPSProjection__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"](center, radius, pxsize);
      } else if (projectionName === "HEALPix") {
        return new _HEALPixProjection__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"](center, radius, pxsize);
      } else {
        throw new _exceptions_ProjectionNotFound__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](projectionName);
      }
    }
  }]);
